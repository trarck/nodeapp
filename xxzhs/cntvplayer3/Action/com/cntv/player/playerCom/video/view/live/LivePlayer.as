package com.cntv.player.playerCom.video.view.live
{
    ...
    public class LivePlayer extends VideoBase
    {
        ...
        private var canGetNewData:Boolean = true;
        ...
        public function LivePlayer(param1:Number = 0)
        {
            ...
            _dispatcher.addEventListener(VideoPlayEvent.EVENT_UPDATA_LIVE_DATA, this.onDataUpdated);
        ...
        private function onDataUpdated(event:VideoPlayEvent) : void
        {
            ...
            {
                if (_modelLocator.movieDuration > _modelLocator.paramVO.endTime - _modelLocator.paramVO.startTime)
                {
                    _modelLocator.limitedDuring = _modelLocator.paramVO.endTime - _modelLocator.paramVO.startTime;
                }
                else if (!this.isLastCharpter())
                {
                    _modelLocator.limitedDuring = _modelLocator.movieDuration - this.defaultStartTime;
                }
                else
                {
                    _modelLocator.limitedDuring = _modelLocator.movieDuration;
                }
            }
            return;
        }// end function
        ...
        private function isLastCharpter() : Boolean
        {
            if (this.totalTime < _modelLocator.paramVO.endTime)
            {
                return false;
            }
            return true;
        ...
        private function loop(event:Event) : void
        {
            ...
            {
                ExternalInterface.call("Print2", "error ...");
            }
            return;
        }// end function
        ...
        public function onMetaData(param1:Object) : void
        {
            ...
            if (_modelLocator.paramVO.isLockLimit)
            {
                ...
                {
                    _modelLocator.limitedDuring = _modelLocator.movieDuration - _modelLocator.paramVO.startTime;
                }
                else
                {
                    _modelLocator.limitedDuring = _modelLocator.paramVO.endTime - _modelLocator.paramVO.startTime;
            ...
            this.getDataTimer = new Timer(30000);
            this.getDataTimer.addEventListener(TimerEvent.TIMER, this.getNewData);
            this.getDataTimer.start();
            return;
        }// end function

        private function getNewData(event:TimerEvent) : void
        {
            if (!this.isLastCharpter())
            {
                new GetNewLiveBackDataProxy().load();
            }
            return;
        }// end function
        ...
        private function callPlayOver() : void
        {
            ...
            this.getDataTimer.removeEventListener(TimerEvent.TIMER, this.getNewData);
            if (ExternalInterface.available)
            {
