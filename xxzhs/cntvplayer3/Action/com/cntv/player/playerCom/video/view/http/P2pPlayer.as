package com.cntv.player.playerCom.video.view.http
{
    ...
    import p2pstream.events.*;
    import p2pstream.loader.*;

    public class P2pPlayer extends VideoBase
    {
        ...
        public function P2pPlayer(param1:Number = 0)
        {
        ...
        private function netStatusHandler(event:NetStatusEvent) : void
        {
            ...
            var _loc_9:StatusVO = null;
            var _loc_10:NetStream = null;
            ...
            switch(event.info.code)
            {
                ...
                case "NetStream.Play.FileStructureInvalid":
                {
                    if (this.ns == event.target)
                    {
                        ...
                        _loc_8.push(_loc_2);
                        _dispatcher.dispatchEvent(new QualityMonitorEvent(QualityMonitorEvent.EVENT_ERROR, _loc_8));
                        _loc_9 = new StatusVO(_modelLocator.i18n.ERROR_CAN_NOT_GET_VIDEO_FILE, StatuBoxEvent.TYPE_CENTER, true);
                        _dispatcher.dispatchEvent(new StatuBoxEvent(StatuBoxEvent.EVENT_SHOW_MESSAGE, _loc_9));
                        _loc_10 = event.target as NetStream;
                        _loc_10 = null;
                    }
                    break;
                }
                case "NetStream.Play.Start":
                {
                    ...
                    _loc_4.push(_loc_2);
                    _dispatcher.dispatchEvent(new QualityMonitorEvent(QualityMonitorEvent.EVENT_LOAD_VIDEO_TIME, _loc_4));
                    ...
                    _loc_3 = event.target as NetStream;
                ...
                case "NetStream.Play.Stop":
                {
                    ...
                    else if (this.isUseP2p && this.nowLocalData && Math.abs(this.ns.time - this.nowLocalData.duration) > END_TIME_DIFF && _modelLocator.paramVO.p2pTrigger)
                    {
                        this.doAP2pJSCheck();
                    }
                    else
                ...
                case "NetStream.Buffer.Empty":
                {
                    ...
                    if (isCanCheckBuffer)
                    {
                        ...
                        _loc_11.push(_loc_2);
                        _dispatcher.dispatchEvent(new QualityMonitorEvent(QualityMonitorEvent.EVENT_AFFLUENT, _loc_11));
                        _loc_11 = [];
                        ...
                        _loc_2 = new ValueOBJ("time", this.currentTime.toString());
                        _loc_11.push(_loc_2);
                        _dispatcher.dispatchEvent(new QualityMonitorEvent(QualityMonitorEvent.EVENT_SWITCH_BUFFER, _loc_11));
                    }
                    break;
                }
                case "NetStream.Buffer.Full":
                {
                    ...
                    _loc_5.push(_loc_2);
                    _loc_6 = Math.floor(bufferTimeLength);
                    if (_loc_6 > 0 && _loc_6 < 150000)
                    {
                        _loc_2 = new ValueOBJ("v", _loc_6.toString());
                        _loc_5.push(_loc_2);
                    }
                    _loc_2 = new ValueOBJ("time", this.currentTime.toString());
                    _loc_5.push(_loc_2);
                    _loc_2 = new ValueOBJ("file", _modelLocator.currentFile);
                    _loc_5.push(_loc_2);
                    _loc_7 = String(Math.random());
                    _loc_2 = new ValueOBJ("radom", _loc_7);
                    _loc_5.push(_loc_2);
                    _dispatcher.dispatchEvent(new QualityMonitorEvent(QualityMonitorEvent.EVENT_BUFFER_LENGTH, _loc_5));
                    var _loc_13:* = bufferTimesCount + 1;
                    bufferTimesCount = _loc_13;
                    break;
                }
                default:
                {
        ...
        private function addNewStream(param1:ChapterVO, param2:Boolean = false) : void
        {
            ...
            _loc_3.ns = new SSNetStream(this.netCon);
            if (this.isHighRate == 1)
            {
                _loc_3.ns.dispatchEvent(new StreamingEvent(StreamingEvent.SET_CONFIG, false, false, this.config2));
            }
            else if (this.isHighRate == 0)
            {
                _loc_3.ns.dispatchEvent(new StreamingEvent(StreamingEvent.SET_CONFIG, false, false, this.config));
            }
            else if (this.isHighRate == 2)
            {
                _loc_3.ns.dispatchEvent(new StreamingEvent(StreamingEvent.SET_CONFIG, false, false, this.config3));
            }
            ...
            _loc_3.ns.addEventListener(IOErrorEvent.IO_ERROR, this.onIoerror);
        ...
        {
            this.netStream = new SSNetStream(this.netCon);
            ...
            this.netStream2 = new SSNetStream(this.netCon);
            ...
            videoBaseContainer.addChild(this.video);
            videoBaseContainer.addChild(this.video2);
            addFloatLogo();
        ...
        {
            this.doRealSeek(this.currentTime);
            return;
        }// end function
        ...
        override public function play() : void
        {
            ...
            if (this._swcLoader == null)
            {
                ...
                this._swcLoader.addEventListener(SWCLoader.COMPLETE, this.onComplete);
                this._swcLoader.addEventListener(SWCLoader.ERROR, this.onError);
                _loc_1 = 6000;
                this._swcLoader.load(_modelLocator.paramVO.ssP2pSwf, _loc_1);
            }
            else
            {
                this.doRealPlay();
        ...
        {
            this._swcLoader.removeEventListener(SWCLoader.COMPLETE, this.onComplete);
            this._swcLoader.removeEventListener(SWCLoader.ERROR, this.onError);
            this.doRealPlay();
            return;
        }// end function
        ...
        private function onComplete(event:Event) : void
        {
            ...
            this._swcLoader.removeEventListener(SWCLoader.COMPLETE, this.onComplete);
            this._swcLoader.removeEventListener(SWCLoader.ERROR, this.onError);
            var _loc_2:* = _modelLocator.paramVO.videoCenterId;
            var _loc_3:String = "std";
            var _loc_4:String = "hd";
            var _loc_5:String = "ld";
            var _loc_6:Number = 128000000;
            var _loc_7:Number = 240;
            var _loc_8:Array = [];
            var _loc_9:Array = [];
            var _loc_10:Array = [];
            var _loc_12:Number = 0;
            _loc_12 = 0;
            while (_loc_12 < _modelLocator.currentVideoInfo.chapters2.length)
            {
                
                _loc_11 = _modelLocator.currentVideoInfo.chapters2[_loc_12] as ChapterVO;
                if (_loc_11)
                {
                    _loc_9.push(_loc_11.url);
                }
                _loc_12 = _loc_12 + 1;
            }
            _loc_12 = 0;
            while (_loc_12 < _modelLocator.currentVideoInfo.chapters.length)
            {
                
                _loc_11 = _modelLocator.currentVideoInfo.chapters[_loc_12] as ChapterVO;
                if (_loc_11)
                {
                    _loc_8.push(_loc_11.url);
                }
                _loc_12 = _loc_12 + 1;
            }
            _loc_12 = 0;
            while (_loc_12 < _modelLocator.currentVideoInfo.lowChapters.length)
            {
                
                _loc_11 = _modelLocator.currentVideoInfo.lowChapters[_loc_12] as ChapterVO;
                if (_loc_11)
                {
                    _loc_10.push(_loc_11.url);
                }
                _loc_12 = _loc_12 + 1;
            }
            this.config = new SSConfig(false, _loc_2, _loc_3, _loc_8, null, null, _loc_6, _loc_7);
            this.config2 = new SSConfig(false, _loc_2, _loc_4, _loc_9, null, null, _loc_6, _loc_7);
            this.config3 = new SSConfig(false, _loc_2, _loc_5, _loc_10, null, null, _loc_6, _loc_7);
            this.doRealPlay();
            return;
        }// end function
        ...
        private function releaseCharpterVO(param1:ChapterVO) : void
        {
            if (param1 != null && param1.ns != null)
            {
                ...
                param1.video.clear();
                param1.ns = null;
                if (videoBaseContainer.contains(param1.video))
                {
                    videoBaseContainer.removeChild(param1.video);
                }
                param1.video = null;
